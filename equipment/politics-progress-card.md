...
title: Politics Progress Card
---
The **Politics Progress Card** is one of the three types of progress cards introduced in [_Cities & Knights_][cities-knights]. There are two different Politics decks: one introduced in [_Cities & Knights_][cities-knights] and one used in select scenarios of [_Legend of the Conquerors_][conquerors]. The two decks, though used identically, are separate from each other and are not meant to be mixed together.
...
- **Diplomacy**: This card allows a road at the end of an open line of roads to be removed from the board. If a player removes one of their own roads, they may place a new road at no cost.
  ...
  - When playing with [_Seafarers_][seafarers], this card can be used with a ship instead of a road.
...
- **Sabotage**: This card has different effects depending on the edition of [_Cities & Knights_][cities-knights].
...
- **Taxation**: This card allows a player to move the robber to any hex, and steal a resource from _all_ players with a settlement or city adjacent to its new location.
  ...
  - When playing with [_Seafarers_][seafarers], this card may _not_ be used to move the pirate.
...
**[_Legend of the Conquerors_][conquerors] Politics Cards**:
- **Bribery**: This card allows a player to remove one of the [Conquerors][conqueror] with the lowest strength rating from the board, and also place a basic knight on the board at no cost.
  - If the player has no basic knights in their supply, the card can still be used to remove a [Conqueror][conqueror]. However, the card cannot be used to place a knight if there are no [Conquerors][conqueror] on the board.
  - This card may be played at any time during a player's own turn, including before the Action Phase.
  - The removal of a [Conqueror][conqueror] by this card's effect does not constitute the defeat of said [Conqueror][conqueror], and as such, no advancement is made on the hero track.
...
- **Neighborly Help**: This card makes all opponents with more victory points than the player give two resource or commodity cards to the player.
  - The opponents may choose which cards to give to the player.
  - Players with only one resource or commodity card in their hand must give the one card if they are affected. Players with no cards in their hand are unaffected.
  - This card is identical to Wedding from the main deck, but is themed specifically for [_Legend of the Conquerors_][conquerors].
...
- **Warlord Roven**: This card allows a player to activate all of their knights at no cost.
  - This card is identical to Encouragement from the main deck, but is themed specifically for [_Legend of the Conquerors_][conquerors].

## Manifest
The [_Cities & Knights_][cities-knights] Politics deck has 18 cards, and consists of the following cards:
- 1 - Constitution
- 2 - Diplomacy
- 2 - Encouragement
- 2 - Espionage
...
The [_Legend of the Conquerors_][conquerors] Politics deck has 18 cards, and consists of the following cards:
- 2 - Bribery
- 2 - Brothers in Arms
- 2 - Help from the South
- 2 - Lea the Healer
- 2 - Neighborly Help
- 2 - Road Building Mission
- 3 - Spy
- 3 - Warlord Roven
