...
title: Strong Knight
---
A **Strong Knight** is one of the three types of [Knight][knight-ck] introduced in [_Cities & Knights_][cities-knights].
...
## Gameplay
Consult with [the game concepts page][knight-ck] for details on the gameplay aspects of Strong Knights and knights in general.

## Manifest
2 Strong Knights are included for the red, blue, orange, and white players in [_Cities & Knights_][cities-knights]. 2 Strong Knights for the green and purple (brown before the English 6th edition / 4th international edition) players are included with the [_Cities & Knights_][cities-knights] extension.
