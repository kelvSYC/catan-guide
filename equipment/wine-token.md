...
title: Wine Token
---
**Wine Tokens** are one of the two currencies introduced in [_Legend of the Conquerors_]({% link products/conquerors.md %}).
...
## Manifest
32 Wine tokens are included with [_Legend of the Conquerors_]({% link products/conquerors.md %})
