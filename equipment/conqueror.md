...
- **The Conquerors Advance**: Conquerors on the board are moved as part of resolving the ["The Conquerors Advance" event][event-conquerors] on the barbarian track. Each event is associated with either a green sword or red sword, which determines the order in which each conqueror on the board will move.
