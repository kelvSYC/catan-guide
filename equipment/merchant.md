...
title: Merchant
---
The **Merchant** is a neutral piece that is put in play using the [Merchant progress card][trade-progress-card].
...
For the English 6th edition, the merchant is instead a gray wagon piece, the piece being reused from [_Traders & Barbarians_][traders-barbarians].
...
- The player to have last played the [Merchant progress card][trade-progress-card] is said to control the merchant. The player in control of the merchant may trade the resource produced by the hex at a 2:1 rate.
