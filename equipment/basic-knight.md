...
title: Basic Knight
---
A **Basic Knight** is one of the three types of [Knight][knight-ck] introduced in [_Cities & Knights_][cities-knights].
...
## Manifest
2 Basic Knights are included for the red, blue, orange, and white players in [_Cities & Knights_][cities-knights]. 2 Basic Knights for the green and purple (brown before the English 6th edition / 4th international edition) players are included with the [_Cities & Knights_][cities-knights] extension.
