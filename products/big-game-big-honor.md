...
## Parts List
Not included with the scenario itself, but downloadable from the _Catan_ website, is a print-out sheet that can be used to print out four Laurel token reference cards.

- Player Pieces
  - 6 Settlers
- 1 Big Game table, assembled from two pieces
- 24 Laurel tokens
- 1 Big Game Champion scoring bonus
