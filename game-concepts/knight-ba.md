...
title: Knight
---
In the scenario "Barbarian Attack", **Knights** are a type of unit that are used to capture barbarians. When playing without [_Cities & Knights_][cities-knights], knights are represented by the knight pieces introduced in [_Traders & Barbarians_][traders-barbarians]. However, when playing with [_Cities & Knights_][cities-knights], they are represented by the knight pieces from that expansion instead.
